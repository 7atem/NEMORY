...
- Benchmark: 100-case deterministic JVM `IntelligenceBenchmarkTest.kt` passes 100/100 across retrieval recall, arithmetic, grounding, anti-hallucination, and cross-document reasoning.
